...
const DEMO_PROFILES: DemoProfile[] = [
  {
    ...
    loanPurpose: 'Inventory Expansion & Working Capital',
    status: 'ASSESSED',
    score: 720,
    riskLevel: 'LOW_MODERATE',
    label: 'Credit Readiness: STRONG',
    monthlyInflows:  [225000, 235000, 240000, 238000, 242000, 240000],
    monthlyOutflows: [170000, 178000, 175000, 172000, 176000, 175000],
    successfulPaymentRatio: 0.96,
    failedPaymentRatio: 0.04,
    refundRatio: 0.02,
    transactionFrequency: 34,
    behaviorScore: 91,
  },
  {
    id: 'demo_app_002',
